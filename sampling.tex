...
% is it necessarily 'time scale' or is it more 'whatever parameters you care about' ?  SH: Probably time scale to keep it from getting too abastract in the second sentence.
