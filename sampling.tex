...
We want to know what we can detect and want to understand the certainty of our estimates. This means
...
%
%%%%%
} average activity rate is calculated by,
...
%%%%%
  ...
  activity rates are high, rate estimates will be more certain; when low, rate estimates will be less certain. High uncertainty
...
$t_f$ and $t_i$ are the final and initial times at which the rate is measured. The associated time 
